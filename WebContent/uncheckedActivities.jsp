<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<%@ page import="com.server.dao.UncheckedActivitiesDAO" %>
            ...
            <ul class="navigation" id="tags">            
                <li class="active">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="uncheckedActivities.jsp">unchecked activities</a></li>
                    </ul>
                </li>
                <li>
        ...
        <div class="body">
            ...
            <div class="content">
                ...
                <div class="page-header">
                    ...
                    <h1>Baned Activities <small>METRO STYLE ADMIN PANEL</small></h1>
                </div>
                            ...
                            <div class="head orange">
                                ...
                                <div class="data-fluid">
                                    <table class="table fpTable lcnp" cellpadding="0" cellspacing="0" width="100%" id="atyTable">
                                        ...
                                        <tbody>
                                        	<%
                                        	UncheckedActivitiesDAO atyDAO = new UncheckedActivitiesDAO();
