<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<%@ page import="com.server.dao.BanedUsersDAO" %>
            ...
            <ul class="navigation" id="tags">            
                ...
                <li class="active">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="banedUsers.jsp">baned users</a></li>
                    </ul>
                </li>
                <li>
        ...
        <div class="body">
            ...
            <div class="content">
                ...
                <div class="page-header">
                    ...
                    <h1>Baned Users <small>METRO STYLE ADMIN PANEL</small></h1>
                </div>
                            ...
                            <div class="head orange">
                                ...
                                <div class="data-fluid">
                                    <table class="table fpTable lcnp" cellpadding="0" cellspacing="0" width="100%" id="userTable">
                                        ...
                                        <tbody>
                                        	<%
                                        	BanedUsersDAO userDAO = new BanedUsersDAO();
