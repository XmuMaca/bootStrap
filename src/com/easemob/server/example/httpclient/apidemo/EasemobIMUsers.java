...
//	private static final JsonNodeFactory factory = new JsonNodeFactory(false);
	...
	public static ObjectNode createNewIMUserSingle(ObjectNode dataNode) {
		...
		System.out.println("in createNew");
		
		factory = new JsonNodeFactory(false);
		
		System.out.println("facetory exist");
	...
	public static void myCreateUser(String userId, String password)
	{
		ObjectNode datanode = JsonNodeFactory.instance.objectNode();
